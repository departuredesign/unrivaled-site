  ...
  <section class="team-section">
    <div class="team-section__inner">
      ...
      <div class="team-grid" data-animate id="leadershipGrid">
        <div class="team-card"><div class="team-card__photo"><div class="ph">Photo</div></div><p class="team-card__name">Andrew Campion</p><p class="team-card__title">Chief Executive Officer &amp; Chairman</p><div class="team-card__divider"></div><a href="#" class="team-card__link"><svg class="team-card__link-arrow" viewBox="0 0 14 12"><path d="M8.5 0.5L13.5 6L8.5 11.5M0.5 6H13"/></svg>LinkedIn</a><div class="team-card__divider--bottom"></div></div>
        <div class="team-card"><div class="team-card__photo"><div class="ph">Photo</div></div><p class="team-card__name">Scott Cotter</p><p class="team-card__title">Chief Financial Officer</p><div class="team-card__divider"></div><a href="#" class="team-card__link"><svg class="team-card__link-arrow" viewBox="0 0 14 12"><path d="M8.5 0.5L13.5 6L8.5 11.5M0.5 6H13"/></svg>LinkedIn</a><div class="team-card__divider--bottom"></div></div>
        <div class="team-card"><div class="team-card__photo"><div class="ph">Photo</div></div><p class="team-card__name">Wade Martin</p><p class="team-card__title">Chief Commercial Officer<br>Chief Executive Officer, Baseball</p><div class="team-card__divider"></div><a href="#" class="team-card__link"><svg class="team-card__link-arrow" viewBox="0 0 14 12"><path d="M8.5 0.5L13.5 6L8.5 11.5M0.5 6H13"/></svg>LinkedIn</a><div class="team-card__divider--bottom"></div></div>
        <div class="team-card"><div class="team-card__photo"><div class="ph">Photo</div></div><p class="team-card__name">Jim Reynolds</p><p class="team-card__title">Chief Executive Officer, Football &amp; Emerging Sports</p><div class="team-card__divider"></div><a href="#" class="team-card__link"><svg class="team-card__link-arrow" viewBox="0 0 14 12"><path d="M8.5 0.5L13.5 6L8.5 11.5M0.5 6H13"/></svg>LinkedIn</a><div class="team-card__divider--bottom"></div></div>
        <div class="team-card"><div class="team-card__photo"><div class="ph">Photo</div></div><p class="team-card__name">Kevin English</p><p class="team-card__title">Partner and CEO, Unrivaled Action</p><div class="team-card__divider"></div><a href="#" class="team-card__link"><svg class="team-card__link-arrow" viewBox="0 0 14 12"><path d="M8.5 0.5L13.5 6L8.5 11.5M0.5 6H13"/></svg>LinkedIn</a><div class="team-card__divider--bottom"></div></div>
        <div class="team-card"><div class="team-card__photo"><div class="ph">Photo</div></div><p class="team-card__name">Erin Clift</p><p class="team-card__title">Chief Marketing Officer</p><div class="team-card__divider"></div><a href="#" class="team-card__link"><svg class="team-card__link-arrow" viewBox="0 0 14 12"><path d="M8.5 0.5L13.5 6L8.5 11.5M0.5 6H13"/></svg>LinkedIn</a><div class="team-card__divider--bottom"></div></div>
        <div class="team-card"><div class="team-card__photo"><div class="ph">Photo</div></div><p class="team-card__name">Dan Burnham</p><p class="team-card__title">Chief Legal Officer</p><div class="team-card__divider"></div><a href="#" class="team-card__link"><svg class="team-card__link-arrow" viewBox="0 0 14 12"><path d="M8.5 0.5L13.5 6L8.5 11.5M0.5 6H13"/></svg>LinkedIn</a><div class="team-card__divider--bottom"></div></div>
        <div class="team-card"><div class="team-card__photo"><div class="ph">Photo</div></div><p class="team-card__name">Amanda Shank</p><p class="team-card__title">Executive Vice President, Strategic Initiatives</p><div class="team-card__divider"></div><a href="#" class="team-card__link"><svg class="team-card__link-arrow" viewBox="0 0 14 12"><path d="M8.5 0.5L13.5 6L8.5 11.5M0.5 6H13"/></svg>LinkedIn</a><div class="team-card__divider--bottom"></div></div>
        <div class="team-card"><div class="team-card__photo"><div class="ph">Photo</div></div><p class="team-card__name">Taylor White</p><p class="team-card__title">Vice President, Human Resources</p><div class="team-card__divider"></div><a href="#" class="team-card__link"><svg class="team-card__link-arrow" viewBox="0 0 14 12"><path d="M8.5 0.5L13.5 6L8.5 11.5M0.5 6H13"/></svg>LinkedIn</a><div class="team-card__divider--bottom"></div></div>
        <div class="team-card"><div class="team-card__photo"><div class="ph">Photo</div></div><p class="team-card__name">Michael Campbell</p><p class="team-card__title">General Counsel</p><div class="team-card__divider"></div><a href="#" class="team-card__link"><svg class="team-card__link-arrow" viewBox="0 0 14 12"><path d="M8.5 0.5L13.5 6L8.5 11.5M0.5 6H13"/></svg>LinkedIn</a><div class="team-card__divider--bottom"></div></div>
        <div class="team-card"><div class="team-card__photo"><div class="ph">Photo</div></div><p class="team-card__name">Jordan Oakes</p><p class="team-card__title">Chief of Staff</p><div class="team-card__divider"></div><a href="#" class="team-card__link"><svg class="team-card__link-arrow" viewBox="0 0 14 12"><path d="M8.5 0.5L13.5 6L8.5 11.5M0.5 6H13"/></svg>LinkedIn</a><div class="team-card__divider--bottom"></div></div>
      </div>
