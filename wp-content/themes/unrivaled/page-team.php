  ...
  <section class="team-section">
    <div class="team-section__inner">
      ...
      <div class="team-grid" data-animate id="investorsGrid">
        <div class="team-card"><div class="team-card__photo"><img src="<?php echo $assets; ?>images/investors/david-blitzer.webp" alt="David Blitzer"></div><p class="team-card__name">David Blitzer</p><p class="team-card__title">Co-Founder, Controlling Partner</p><div class="team-card__divider"></div></div>
        <div class="team-card"><div class="team-card__photo"><img src="<?php echo $assets; ?>images/investors/josh-harris.webp" alt="Josh Harris"></div><p class="team-card__name">Josh Harris</p><p class="team-card__title">Co-Founder, Controlling Partner</p><div class="team-card__divider"></div></div>
        <div class="team-card team-card--partner"><div class="team-card__photo"><img src="<?php echo $assets; ?>images/investors/the-chernin-group.svg" alt="The Chernin Group"></div><p class="team-card__name">The Chernin Group</p><p class="team-card__title">Investor</p><div class="team-card__divider"></div></div>
        <div class="team-card team-card--partner"><div class="team-card__photo"><img src="<?php echo $assets; ?>images/investors/dicks-sporting-goods.png" alt="Dick's Sporting Goods"></div><p class="team-card__name">Dick&rsquo;s Sporting Goods</p><p class="team-card__title">Investor</p><div class="team-card__divider"></div></div>
        <div class="team-card team-card--partner"><div class="team-card__photo"><img src="<?php echo $assets; ?>images/investors/dynasty-equity.png" alt="Dynasty Equity"></div><p class="team-card__name">Dynasty Equity</p><p class="team-card__title">Investor</p><div class="team-card__divider"></div></div>
        <div class="team-card team-card--partner"><div class="team-card__photo"><img src="<?php echo $assets; ?>images/investors/liontree.png" alt="LionTree"></div><p class="team-card__name">LionTree</p><p class="team-card__title">Investor</p><div class="team-card__divider"></div></div>
        <div class="team-card team-card--partner"><div class="team-card__photo"><img src="<?php echo $assets; ?>images/investors/miller-sports-entertainment.png" alt="Miller Sports &amp; Entertainment"></div><p class="team-card__name">Miller Sports &amp; Entertainment</p><p class="team-card__title">Investor</p><div class="team-card__divider"></div></div>
        <div class="team-card"><div class="team-card__photo"><img src="<?php echo $assets; ?>images/investors/isaac-harrouche.jpg" alt="Isaac Harrouche"></div><p class="team-card__name">Isaac Harrouche</p><p class="team-card__title">Co-Founder, Managing Partner</p><div class="team-card__divider"></div></div>
        <div class="team-card"><div class="team-card__photo"><img src="<?php echo $assets; ?>images/investors/neel-joshi.webp" alt="Neel Joshi"></div><p class="team-card__name">Neel Joshi</p><p class="team-card__title">Co-Founder, Managing Partner</p><div class="team-card__divider"></div></div>
        <div class="team-card"><div class="team-card__photo"><img src="<?php echo $assets; ?>images/investors/greg-bettinelli.webp" alt="Greg Bettinelli"></div><p class="team-card__name">Greg Bettinelli</p><p class="team-card__title">Partner, TGC</p><div class="team-card__divider"></div></div>
        <div class="team-card"><div class="team-card__photo"><img src="<?php echo $assets; ?>images/investors/cal-ripken-jr.webp" alt="Cal Ripken, Jr."></div><p class="team-card__name">Cal Ripken, Jr.</p><p class="team-card__title">Partner</p><div class="team-card__divider"></div></div>
        <div class="team-card"><div class="team-card__photo"><img src="<?php echo $assets; ?>images/investors/bill-ripken.webp" alt="Bill Ripken"></div><p class="team-card__name">Bill Ripken</p><p class="team-card__title">Partner</p><div class="team-card__divider"></div></div>
        <div class="team-card"><div class="team-card__photo"><img src="<?php echo $assets; ?>images/investors/shaun-white.webp" alt="Shaun White"></div><p class="team-card__name">Shaun White</p><p class="team-card__title">Partner</p><div class="team-card__divider"></div></div>
        <div class="team-card"><div class="team-card__photo"><img src="<?php echo $assets; ?>images/investors/tory-palmer.jpg" alt="Tory Palmer"></div><p class="team-card__name">Tory Palmer</p><p class="team-card__title">Investor, Bolt Ventures</p><div class="team-card__divider"></div></div>
        <div class="team-card"><div class="team-card__photo"><img src="<?php echo $assets; ?>images/investors/marty-brenda-patton.png" alt="Marty and Brenda Patton"></div><p class="team-card__name">Marty and Brenda Patton</p><p class="team-card__title">Co-Founders of Cooperstown All Star Village</p><div class="team-card__divider"></div></div>
        <div class="team-card"><div class="team-card__photo"><img src="<?php echo $assets; ?>images/investors/cust-family.webp" alt="Cust Family"></div><p class="team-card__name">Cust Family</p><p class="team-card__title">Co-Founders of Diamond Nation</p><div class="team-card__divider"></div></div>
      </div>
    </div>
  </section>
