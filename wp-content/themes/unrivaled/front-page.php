...
<path d="M156.655 100.212C166.722 97.528 170.092 102.311 164.142 110.846C157.271 120.702 160.903 125.403 172.211 121.297L434 26.2306H247.736C244.967 26.2306 241.277 27.986 239.541 30.1332L191.322 89.6114C188.635 92.8322 186.312 91.4249 188.495 87.6673L231.346 14.5129C236.025 6.52863 232.267 0 222.996 0H92.3755L0 142L156.655 100.212Z" fill="currentColor"/>
    ...
    <div class="section-wrapper__inner" style="padding-top:0;padding-bottom:0;">
      <div class="carousel" data-variant="events" data-speed="40">
        <div class="carousel__track">
          <div class="carousel__slide"><div class="carousel__slide-image carousel__slide-image--narrow"><img src="<?php echo $assets; ?>images/events/ripken.webp" alt="Ripken 2025 championships"></div><p class="carousel__slide-venue">Ripken</p><p class="carousel__slide-desc">2025 championships All-Star game</p></div>
          <div class="carousel__slide"><div class="carousel__slide-image carousel__slide-image--medium"><img src="<?php echo $assets; ?>images/events/rocker-b-ranch.webp" alt="Rocker B Ranch"></div><p class="carousel__slide-venue">Rocker B Ranch</p><p class="carousel__slide-desc">Ripken National Qualifiers</p></div>
          <div class="carousel__slide"><div class="carousel__slide-image carousel__slide-image--wide"><img src="<?php echo $assets; ?>images/events/ripken-aberdeen.webp" alt="Ripken Aberdeen"></div><p class="carousel__slide-venue">Ripken Aberdeen</p><p class="carousel__slide-desc">2025 champ</p></div>
          <div class="carousel__slide"><div class="carousel__slide-image carousel__slide-image--narrow"><img src="<?php echo $assets; ?>images/events/unrivaled-flag.webp" alt="Unrivaled Flag"></div><p class="carousel__slide-venue">Unrivaled Flag</p><p class="carousel__slide-desc">2025 high school girls championships</p></div>
          <div class="carousel__slide"><div class="carousel__slide-image carousel__slide-image--wide"><img src="<?php echo $assets; ?>images/events/ripken-myrtle-beach.webp" alt="Ripken Myrtle Beach"></div><p class="carousel__slide-venue">Ripken Myrtle Beach</p><p class="carousel__slide-desc">Softball championships</p></div>
          <!-- Duplicate set -->
          <div class="carousel__slide" aria-hidden="true"><div class="carousel__slide-image carousel__slide-image--narrow"><img src="<?php echo $assets; ?>images/events/ripken.webp" alt=""></div><p class="carousel__slide-venue">Ripken</p><p class="carousel__slide-desc">2025 championships All-Star game</p></div>
          <div class="carousel__slide" aria-hidden="true"><div class="carousel__slide-image carousel__slide-image--medium"><img src="<?php echo $assets; ?>images/events/rocker-b-ranch.webp" alt=""></div><p class="carousel__slide-venue">Rocker B Ranch</p><p class="carousel__slide-desc">Ripken National Qualifiers</p></div>
          <div class="carousel__slide" aria-hidden="true"><div class="carousel__slide-image carousel__slide-image--wide"><img src="<?php echo $assets; ?>images/events/ripken-aberdeen.webp" alt=""></div><p class="carousel__slide-venue">Ripken Aberdeen</p><p class="carousel__slide-desc">2025 champ</p></div>
          <div class="carousel__slide" aria-hidden="true"><div class="carousel__slide-image carousel__slide-image--narrow"><img src="<?php echo $assets; ?>images/events/unrivaled-flag.webp" alt=""></div><p class="carousel__slide-venue">Unrivaled Flag</p><p class="carousel__slide-desc">2025 high school girls championships</p></div>
          <div class="carousel__slide" aria-hidden="true"><div class="carousel__slide-image carousel__slide-image--wide"><img src="<?php echo $assets; ?>images/events/ripken-myrtle-beach.webp" alt=""></div><p class="carousel__slide-venue">Ripken Myrtle Beach</p><p class="carousel__slide-desc">Softball championships</p></div>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="section-wrapper" data-variant="dark">
    <div class="section-wrapper__inner">
      ...
      <div class="brand-grid" data-animate id="brandGrid">
        <div class="brand-card"><div class="brand-card__image"><img src="<?php echo $assets; ?>images/brands/cooperstown-all-star-village.webp" alt="Cooperstown All Star Village"></div><p class="brand-card__name">Cooperstown All Star Village</p><div class="brand-card__divider"></div><a href="https://cooperstown.com/" target="_blank" rel="noopener noreferrer" class="visit-site-link"><svg class="visit-site-link__arrow" viewBox="0 0 23 13"><path d="M22.4262 6.11868L0 12.2325V0L22.4262 6.11868Z" fill="#0162FF"/></svg><span class="visit-site-link__text">Visit Site</span></a><div class="brand-card__divider"></div></div>
        <div class="brand-card"><div class="brand-card__image"><img src="<?php echo $assets; ?>images/brands/ripken-baseball.webp" alt="Ripken Baseball"></div><p class="brand-card__name">Ripken Baseball</p><div class="brand-card__divider"></div><a href="https://ripkenbaseball.com/" target="_blank" rel="noopener noreferrer" class="visit-site-link"><svg class="visit-site-link__arrow" viewBox="0 0 23 13"><path d="M22.4262 6.11868L0 12.2325V0L22.4262 6.11868Z" fill="#0162FF"/></svg><span class="visit-site-link__text">Visit Site</span></a><div class="brand-card__divider"></div></div>
        <div class="brand-card"><div class="brand-card__image"><img src="<?php echo $assets; ?>images/brands/unrivaled-flag.webp" alt="Unrivaled Flag"></div><p class="brand-card__name">Unrivaled Flag</p><div class="brand-card__divider"></div><a href="https://unrivaledflag.com/" target="_blank" rel="noopener noreferrer" class="visit-site-link"><svg class="visit-site-link__arrow" viewBox="0 0 23 13"><path d="M22.4262 6.11868L0 12.2325V0L22.4262 6.11868Z" fill="#0162FF"/></svg><span class="visit-site-link__text">Visit Site</span></a><div class="brand-card__divider"></div></div>
        <div class="brand-card"><div class="brand-card__image"><img src="<?php echo $assets; ?>images/brands/rocker-b-ranch.webp" alt="Rocker B Ranch"></div><p class="brand-card__name">Rocker B Ranch</p><div class="brand-card__divider"></div><a href="https://www.rockerb.com/" target="_blank" rel="noopener noreferrer" class="visit-site-link"><svg class="visit-site-link__arrow" viewBox="0 0 23 13"><path d="M22.4262 6.11868L0 12.2325V0L22.4262 6.11868Z" fill="#0162FF"/></svg><span class="visit-site-link__text">Visit Site</span></a><div class="brand-card__divider"></div></div>
        <div class="brand-card"><div class="brand-card__image"><img src="<?php echo $assets; ?>images/brands/ripken-experience-aberdeen.webp" alt="Ripken Experience Aberdeen"></div><p class="brand-card__name">Ripken Experience Aberdeen</p><div class="brand-card__divider"></div><a href="https://ripkenbaseball.com/locations/aberdeen/" target="_blank" rel="noopener noreferrer" class="visit-site-link"><svg class="visit-site-link__arrow" viewBox="0 0 23 13"><path d="M22.4262 6.11868L0 12.2325V0L22.4262 6.11868Z" fill="#0162FF"/></svg><span class="visit-site-link__text">Visit Site</span></a><div class="brand-card__divider"></div></div>
        <div class="brand-card"><div class="brand-card__image"><img src="<?php echo $assets; ?>images/brands/ripken-experience-myrtle-beach.webp" alt="Ripken Experience Myrtle Beach"></div><p class="brand-card__name">Ripken Experience Myrtle Beach</p><div class="brand-card__divider"></div><a href="https://ripkenbaseball.com/locations/myrtle-beach/" target="_blank" rel="noopener noreferrer" class="visit-site-link"><svg class="visit-site-link__arrow" viewBox="0 0 23 13"><path d="M22.4262 6.11868L0 12.2325V0L22.4262 6.11868Z" fill="#0162FF"/></svg><span class="visit-site-link__text">Visit Site</span></a><div class="brand-card__divider"></div></div>
        <div class="brand-card"><div class="brand-card__image"><img src="<?php echo $assets; ?>images/brands/ripken-experience-pigeon-forge.webp" alt="Ripken Experience Pigeon Forge"></div><p class="brand-card__name">Ripken Experience Pigeon Forge</p><div class="brand-card__divider"></div><a href="https://ripkenbaseball.com/locations/pigeon-forge/" target="_blank" rel="noopener noreferrer" class="visit-site-link"><svg class="visit-site-link__arrow" viewBox="0 0 23 13"><path d="M22.4262 6.11868L0 12.2325V0L22.4262 6.11868Z" fill="#0162FF"/></svg><span class="visit-site-link__text">Visit Site</span></a><div class="brand-card__divider"></div></div>
        <div class="brand-card"><div class="brand-card__image"><img src="<?php echo $assets; ?>images/brands/forever-lawn-sports-complex.webp" alt="ForeverLawn Sports Complex"></div><p class="brand-card__name">ForeverLawn Sports Complex</p><div class="brand-card__divider"></div><a href="https://www.hofvillage.com/p/getinvolved/venue/foreverlawn-sports-complex/facility" target="_blank" rel="noopener noreferrer" class="visit-site-link"><svg class="visit-site-link__arrow" viewBox="0 0 23 13"><path d="M22.4262 6.11868L0 12.2325V0L22.4262 6.11868Z" fill="#0162FF"/></svg><span class="visit-site-link__text">Visit Site</span></a><div class="brand-card__divider"></div></div>
        <div class="brand-card"><div class="brand-card__image"><img src="<?php echo $assets; ?>images/brands/diamond-nation.webp" alt="Diamond Nation"></div><p class="brand-card__name">Diamond Nation</p><div class="brand-card__divider"></div><a href="http://www.diamondnation.com" target="_blank" rel="noopener noreferrer" class="visit-site-link"><svg class="visit-site-link__arrow" viewBox="0 0 23 13"><path d="M22.4262 6.11868L0 12.2325V0L22.4262 6.11868Z" fill="#0162FF"/></svg><span class="visit-site-link__text">Visit Site</span></a><div class="brand-card__divider"></div></div>
        <div class="brand-card"><div class="brand-card__image"><img src="<?php echo $assets; ?>images/brands/big-league-dreams.webp" alt="Big League Dreams: Las Vegas &amp; Manteca"></div><p class="brand-card__name">Big League Dreams: Las Vegas &amp; Manteca</p><div class="brand-card__divider"></div><a href="https://bigleaguedreams.com/" target="_blank" rel="noopener noreferrer" class="visit-site-link"><svg class="visit-site-link__arrow" viewBox="0 0 23 13"><path d="M22.4262 6.11868L0 12.2325V0L22.4262 6.11868Z" fill="#0162FF"/></svg><span class="visit-site-link__text">Visit Site</span></a><div class="brand-card__divider"></div></div>
        <div class="brand-card"><div class="brand-card__image"><img src="<?php echo $assets; ?>images/brands/sports-force-park.webp" alt="Sports Force Park"></div><p class="brand-card__name">Sports Force Park</p><div class="brand-card__divider"></div><a href="https://sportsforceparkssandusky.com/" target="_blank" rel="noopener noreferrer" class="visit-site-link"><svg class="visit-site-link__arrow" viewBox="0 0 23 13"><path d="M22.4262 6.11868L0 12.2325V0L22.4262 6.11868Z" fill="#0162FF"/></svg><span class="visit-site-link__text">Visit Site</span></a><div class="brand-card__divider"></div></div>
        <div class="brand-card"><div class="brand-card__image"><img src="<?php echo $assets; ?>images/brands/under-the-lights-flag-football.webp" alt="Under the Lights Flag Football"></div><p class="brand-card__name">Under the Lights Flag Football</p><div class="brand-card__divider"></div><a href="https://www.uaflag.com/" target="_blank" rel="noopener noreferrer" class="visit-site-link"><svg class="visit-site-link__arrow" viewBox="0 0 23 13"><path d="M22.4262 6.11868L0 12.2325V0L22.4262 6.11868Z" fill="#0162FF"/></svg><span class="visit-site-link__text">Visit Site</span></a><div class="brand-card__divider"></div></div>
      </div>
      ...
      <div class="brand-grid brand-grid--overflow" id="brandGridOverflow">
        <div class="brand-card"><div class="brand-card__image"><img src="<?php echo $assets; ?>images/brands/new-england-flag-football.webp" alt="New England Flag Football"></div><p class="brand-card__name">New England Flag Football</p><div class="brand-card__divider"></div><a href="https://www.newenglandflagfootball.com/" target="_blank" rel="noopener noreferrer" class="visit-site-link"><svg class="visit-site-link__arrow" viewBox="0 0 23 13"><path d="M22.4262 6.11868L0 12.2325V0L22.4262 6.11868Z" fill="#0162FF"/></svg><span class="visit-site-link__text">Visit Site</span></a><div class="brand-card__divider"></div></div>
        <div class="brand-card"><div class="brand-card__image"><img src="<?php echo $assets; ?>images/brands/all-american-flag.webp" alt="All American Flag"></div><p class="brand-card__name">All American Flag</p><div class="brand-card__divider"></div><a href="https://footballyouth.com/" target="_blank" rel="noopener noreferrer" class="visit-site-link"><svg class="visit-site-link__arrow" viewBox="0 0 23 13"><path d="M22.4262 6.11868L0 12.2325V0L22.4262 6.11868Z" fill="#0162FF"/></svg><span class="visit-site-link__text">Visit Site</span></a><div class="brand-card__divider"></div></div>
        <div class="brand-card"><div class="brand-card__image"><img src="<?php echo $assets; ?>images/brands/all-ripken.webp" alt="All-Ripken"></div><p class="brand-card__name">All-Ripken</p><div class="brand-card__divider"></div><a href="https://allripken.com/" target="_blank" rel="noopener noreferrer" class="visit-site-link"><svg class="visit-site-link__arrow" viewBox="0 0 23 13"><path d="M22.4262 6.11868L0 12.2325V0L22.4262 6.11868Z" fill="#0162FF"/></svg><span class="visit-site-link__text">Visit Site</span></a><div class="brand-card__divider"></div></div>
        <div class="brand-card"><div class="brand-card__image"><img src="<?php echo $assets; ?>images/brands/baseball-factory.webp" alt="Baseball Factory"></div><p class="brand-card__name">Baseball Factory</p><div class="brand-card__divider"></div><a href="https://www.baseballfactory.com/" target="_blank" rel="noopener noreferrer" class="visit-site-link"><svg class="visit-site-link__arrow" viewBox="0 0 23 13"><path d="M22.4262 6.11868L0 12.2325V0L22.4262 6.11868Z" fill="#0162FF"/></svg><span class="visit-site-link__text">Visit Site</span></a><div class="brand-card__divider"></div></div>
        <div class="brand-card"><div class="brand-card__image"><img src="<?php echo $assets; ?>images/brands/softball-factory.webp" alt="Softball Factory"></div><p class="brand-card__name">Softball Factory</p><div class="brand-card__divider"></div><a href="https://www.softballfactory.com/" target="_blank" rel="noopener noreferrer" class="visit-site-link"><svg class="visit-site-link__arrow" viewBox="0 0 23 13"><path d="M22.4262 6.11868L0 12.2325V0L22.4262 6.11868Z" fill="#0162FF"/></svg><span class="visit-site-link__text">Visit Site</span></a><div class="brand-card__divider"></div></div>
        <div class="brand-card"><div class="brand-card__image"><img src="<?php echo $assets; ?>images/brands/we-are-camp.webp" alt="We Are Camp"></div><p class="brand-card__name">We Are Camp</p><div class="brand-card__divider"></div><a href="https://wearecamp.com/" target="_blank" rel="noopener noreferrer" class="visit-site-link"><svg class="visit-site-link__arrow" viewBox="0 0 23 13"><path d="M22.4262 6.11868L0 12.2325V0L22.4262 6.11868Z" fill="#0162FF"/></svg><span class="visit-site-link__text">Visit Site</span></a><div class="brand-card__divider"></div></div>
        <div class="brand-card"><div class="brand-card__image"><img src="<?php echo $assets; ?>images/brands/snobahn.webp" alt="Snöbahn"></div><p class="brand-card__name">Snöbahn</p><div class="brand-card__divider"></div><a href="https://snobahn.com/" target="_blank" rel="noopener noreferrer" class="visit-site-link"><svg class="visit-site-link__arrow" viewBox="0 0 23 13"><path d="M22.4262 6.11868L0 12.2325V0L22.4262 6.11868Z" fill="#0162FF"/></svg><span class="visit-site-link__text">Visit Site</span></a><div class="brand-card__divider"></div></div>
        <div class="brand-card"><div class="brand-card__image"><img src="<?php echo $assets; ?>images/brands/high-cascade.webp" alt="High Cascade"></div><p class="brand-card__name">High Cascade</p><div class="brand-card__divider"></div><a href="https://highcascade.com/" target="_blank" rel="noopener noreferrer" class="visit-site-link"><svg class="visit-site-link__arrow" viewBox="0 0 23 13"><path d="M22.4262 6.11868L0 12.2325V0L22.4262 6.11868Z" fill="#0162FF"/></svg><span class="visit-site-link__text">Visit Site</span></a><div class="brand-card__divider"></div></div>
        <div class="brand-card"><div class="brand-card__image"><img src="<?php echo $assets; ?>images/brands/windells.webp" alt="Windells"></div><p class="brand-card__name">Windells</p><div class="brand-card__divider"></div><a href="https://windells.com/" target="_blank" rel="noopener noreferrer" class="visit-site-link"><svg class="visit-site-link__arrow" viewBox="0 0 23 13"><path d="M22.4262 6.11868L0 12.2325V0L22.4262 6.11868Z" fill="#0162FF"/></svg><span class="visit-site-link__text">Visit Site</span></a><div class="brand-card__divider"></div></div>
        <div class="brand-card"><div class="brand-card__image"><img src="<?php echo $assets; ?>images/brands/seek-skate-camp.webp" alt="Seek Skate Camp"></div><p class="brand-card__name">Seek Skate Camp</p><div class="brand-card__divider"></div><a href="https://seekskatecamp.com/" target="_blank" rel="noopener noreferrer" class="visit-site-link"><svg class="visit-site-link__arrow" viewBox="0 0 23 13"><path d="M22.4262 6.11868L0 12.2325V0L22.4262 6.11868Z" fill="#0162FF"/></svg><span class="visit-site-link__text">Visit Site</span></a><div class="brand-card__divider"></div></div>
        <div class="brand-card"><div class="brand-card__image"><img src="<?php echo $assets; ?>images/brands/milepost-35.webp" alt="Milepost 35"></div><p class="brand-card__name">Milepost 35</p><div class="brand-card__divider"></div><a href="https://www.milepost35.com/" target="_blank" rel="noopener noreferrer" class="visit-site-link"><svg class="visit-site-link__arrow" viewBox="0 0 23 13"><path d="M22.4262 6.11868L0 12.2325V0L22.4262 6.11868Z" fill="#0162FF"/></svg><span class="visit-site-link__text">Visit Site</span></a><div class="brand-card__divider"></div></div>
      </div>
  ...
  <section class="section-wrapper" data-variant="light" id="press">
    ...
    <div class="press-track" style="padding-left: 60px;">
      <a href="#" class="press-card"><div class="press-card__image"><img src="<?php echo $assets; ?>images/press/unrivaled-sports-announces.webp" alt="Unrivaled Sports Announces Long-Term Investment in Twin Creeks Sports Complex"></div><div class="press-card__body"><h3 class="press-card__title">Unrivaled Sports Announces Long-Term Investment in Twin Creeks Sports Complex</h3><div class="press-card__footer"><div class="press-card__card-divider"></div><time class="press-card__date">12.9.2025</time></div></div></a>
      <a href="#" class="press-card"><div class="press-card__image"><img src="<?php echo $assets; ?>images/press/ashlea-klam-is-on-a-mission.webp" alt="Ashlea Klam Is On A Mission To Shape The Future Of Flag Football"></div><div class="press-card__body"><h3 class="press-card__title">Ashlea Klam Is On A Mission To Shape The Future Of Flag Football</h3><div class="press-card__footer"><div class="press-card__card-divider"></div><time class="press-card__date">12.3.2025</time></div></div></a>
      <a href="#" class="press-card"><div class="press-card__image"><img src="<?php echo $assets; ?>images/press/nfl-legend-drew-brees.webp" alt="NFL Legend Drew Brees Announces Major Flag Football Partnership With Unrivaled Sports"></div><div class="press-card__body"><h3 class="press-card__title">NFL Legend Drew Brees Announces Major Flag Football Partnership With Unrivaled Sports</h3><div class="press-card__footer"><div class="press-card__card-divider"></div><time class="press-card__date">10.21.2025</time></div></div></a>
      <a href="#" class="press-card"><div class="press-card__image"><img src="<?php echo $assets; ?>images/press/hall-of-fame-resort.webp" alt="Hall Of Fame Resort and Entertainment Company Partners With Josh Harris And David Blitzer To Elevate"></div><div class="press-card__body"><h3 class="press-card__title">Hall Of Fame Resort &amp; Entertainment Company Partners With Josh Harris And David Blitzer To Elevate</h3><div class="press-card__footer"><div class="press-card__card-divider"></div><time class="press-card__date">12.9.2025</time></div></div></a>
      <a href="#" class="press-card"><div class="press-card__image"><img src="<?php echo $assets; ?>images/press/hall-of-fame-resort.webp" alt="Hall Of Fame Resort and Entertainment Company Partners With Josh Harris And David Blitzer To Elevate"></div><div class="press-card__body"><h3 class="press-card__title">Hall Of Fame Resort &amp; Entertainment Company Partners With Josh Harris And David Blitzer To Elevate</h3><div class="press-card__footer"><div class="press-card__card-divider"></div><time class="press-card__date">12.9.2025</time></div></div></a>
    </div>
  </section>
  ...
  <footer class="site-footer" id="contact">
    <div class="site-footer__inner">
      <div class="site-footer__main">
        ...
        <div class="site-footer__col"><p class="site-footer__label">Follow Us</p><a href="#" class="site-footer__link">Facebook</a><a href="https://www.instagram.com/unrivaled.sports/" target="_blank" rel="noopener noreferrer" class="site-footer__link">Instagram</a><a href="https://www.linkedin.com/company/unrivaled-sports" target="_blank" rel="noopener noreferrer" class="site-footer__link">LinkedIn</a></div>
